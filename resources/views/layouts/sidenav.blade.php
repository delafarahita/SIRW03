      ...
      <li role="separator" class="dropdown-divider mt-4 mb-3 border-gray-700"></li>
        ...
        <li class="nav-item {{ Request::segment(1) == 'bantuan_sosial' ? 'active' : '' }}">
          <a href="/transactions" class="nav-link">
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M10 0C4.486 0 0 4.486 0 10c0 2.118.66 4.092 1.784 5.715a1 1 0 001.658-1.143A8 8 0 0110 2c3.981 0 7.251 2.896 7.844 6.715a1 1 0 001.658 1.143A10 10 0 102 10a9.983 9.983 0 002.89 7.07 1 1 0 001.658-1.142A7.982 7.982 0 0110 18a8 8 0 100-16z" clip-rule="evenodd"></path>
              </svg>
            </span>
            <span class="sidebar-text">Bantuan Sosial</span>
          </a>
        ...
        <li class="nav-item {{ Request::segment(1) == 'umkm' ? 'active' : '' }}">
          <a href="{{url('/umkm')}}" class="nav-link">
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4 2a1 1 0 00-1 1v14a1 1 0 102 0V6h12a1 1 0 100-2H4zm0-2h12a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V2a2 2 0 012-2z" clip-rule="evenodd"></path>
              </svg>
            </span>
            <span class="sidebar-text">UMKM</span>
          </a>
        ...
        <li class="nav-item {{ Request::segment(1) == 'keluhan' ? 'active' : '' }}">
          <a href="{{url('/keluhan')}}" class="nav-link">
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M6 5a3 3 0 113 3 3 3 0 01-3-3zM1 8a7 7 0 1114 0h2a9 9 0 01-9 9 9 9 0 01-9-9H1zm12-3a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
              </svg>
            </span>
            <span class="sidebar-text">Pengaduan</span>
          </a>
        ...
        <li class="nav-item {{ Request::segment(1) == 'kegiatan' ? 'active' : '' }}">
          <a href="{{url('/Kegiatan')}}" class="nav-link">
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M5 3a1 1 0 00-1 1v1H2a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V7a2 2 0 00-2-2h-2V4a1 1 0 00-2 0v1H6V4a1 1 0 00-1-1zm2 11h8a1 1 0 100-2H7a1 1 0 100 2zm0-4h6a1 1 0 100-2H9a1 1 0 100 2zm0-4h4a1 1 0 100-2H9a1 1 0 100 2z" clip-rule="evenodd"></path>
              </svg>
            </span>
            <span class="sidebar-text">Informasi Kegiatan</span>
          </a>
