    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('admin/data_kk/') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label for="kepala_kelaurga" class="col-sm-2 col-form-label">Kepala Keluarga</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('kepala_kelaurga') is-invalid @enderror" id="kepala_kelaurga" name="kepala_kelaurga" value="{{ old('kepala_kelaurga') }}" required>
                        @error('kepala_kelaurga')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
